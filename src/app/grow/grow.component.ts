...
export class GrowComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.data.changeName(["Puzzling Potions","#F5B971", "puzzling-potions"], ["New World", "#dddddd", "new-world"], ["Pollinate", "#A9C5A8", "pollinate"], ["Project Cupid", "#CFB5D0", "project-cupid"])
